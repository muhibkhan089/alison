...
class Sharing extends \Magento\Framework\View\Element\Template
{
    ...
    public function getCustomerEmails($ergoId)
    {
        $query = $this->_queryFacotry->create()->getCollection()->addFieldToFilter('ergo_id',$ergoId)->getData();
        // return $query->getSelect()->group('customer_email')->getData();
        return $query;
    }

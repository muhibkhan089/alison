<?php
namespace Magenest\Moneris\Gateway\Helper;
...
class SubjectReader
{
     ...
     * @return string
     */
    public static function readTicket(array $subject)
    {
     ...
     * @return string
     */
    public static function readHppId(array $subject)
    {
     ...
     * @return string
     */
    public static function readPaymentUrl(array $subject)
    {

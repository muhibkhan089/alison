<?php
namespace Redgiant\Berserk\Model\Cssconfig;
...
class Generator
{
    ...
    public function __construct(
        \Redgiant\Berserk\Helper\Cssconfig $cssconfigData,
    ...
    protected function generateStoreCss($type, $storeId) {
        ...
        $str4 = 'berserk/css/'.$type.'.phtml';
        $this->_coreRegistry->register('cssgen_store', $storeCode);

        try {
            $block = $this->_layoutManager->createBlock('Redgiant\Berserk\Block\Template')->setData('area','frontend')->setTemplate($str4)->toHtml();

<?php
namespace Redgiant\Berserk\Model\Import;
...
class Demo
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Redgiant/Berserk/etc/import/';
    ...
    public function importDemo($demo_version,$store=NULL,$website = NULL)
    {
        ...
        try {
            ...
            $this->_objectManager->get('Redgiant\Berserk\Model\Cssconfig\Generator')->generateCss('design','','');
            $this->_objectManager->get('Redgiant\Berserk\Model\Cssconfig\Generator')->generateCss('settings','','');

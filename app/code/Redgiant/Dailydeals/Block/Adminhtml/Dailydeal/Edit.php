<?php
namespace Redgiant\Dailydeals\Block\Adminhtml\Dailydeal;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Redgiant_Dailydeals';
    ...
    public function getHeaderText()
    {
        ...
        $dailydeal = $this->coreRegistry->registry('rg_dailydeals_dailydeal');
        if ($dailydeal->getId()) {
            return __("Edit Dailydeal '%1'", $this->escapeHtml($dailydeal->getRg_product_sku()));
        }

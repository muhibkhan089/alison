...
class Bestsellerslist extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        if ($this->getRequest()->isAjax()){
            ...
            $block = $this->_view->getLayout()->createBlock('Redgiant\Filterproducts\Block\Home\BestsellersList')

...
namespace Redgiant\LayeredNavigation\Model\Layer\Filter;
...
/**
 * Class Price
 * @package Redgiant\LayeredNavigation\Model\Layer\Filter
 */
class Price extends AbstractFilter
{
    ...
    {
        /** @var \Redgiant\LayeredNavigation\Model\ResourceModel\Fulltext\Collection $productCollection */
        $productCollection = $this->getLayer()->getProductCollection();

        if ($this->_filterVal) {
            /** @type \Redgiant\LayeredNavigation\Model\ResourceModel\Fulltext\Collection $productCollectionClone */

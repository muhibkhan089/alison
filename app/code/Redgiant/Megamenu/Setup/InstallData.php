<?php
namespace Redgiant\Megamenu\Setup;
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $menu_attributes = [
            ...
            'rg_menu_type' => [
                ...
                'label' => 'Menu Type',
                'input' => 'select',
                'source' => 'Redgiant\Megamenu\Model\Attribute\Menutype',
                'required' => false,
                'sort_order' => 20,
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                'group' => 'RG Menu'
            ...
            'rg_menu_cat_columns' => [
                ...
                'input' => 'select',
                'source' => 'Redgiant\Megamenu\Model\Attribute\Subcatcolumns',
                'required' => false,
                'sort_order' => 40,
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                'group' => 'RG Menu'
            ...
            'rg_menu_float_type' => [
                ...
                'label' => 'Float',
                'input' => 'select',
                'source' => 'Redgiant\Megamenu\Model\Attribute\Floattype',
                'required' => false,
                'sort_order' => 50,
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                'group' => 'RG Menu'
            ...
            'rg_menu_cat_label' => [
                ...
                'input' => 'select',
                'source' => 'Redgiant\Megamenu\Model\Attribute\Categorylabel',
                'required' => false,
                'sort_order' => 60,
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                'group' => 'RG Menu'
            ...
            'rg_menu_block_left_width' => [
                ...
                'input' => 'select',
                'source' => 'Redgiant\Megamenu\Model\Attribute\Width',
                'required' => false,
                'sort_order' => 100,
                'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                'group' => 'RG Menu'
        ...
        $idg =  $categorySetup->getAttributeGroupId($entityTypeId, $attributeSetId, 'RG Menu');
